...
routes.get("/users/me", validaToken, asyncHandler((req, res) => userController.me(req, res)));
routes.get("/admin/ping", validaToken, validaRole(UserRole.ADMIN), asyncHandler(async (req, res) => {
